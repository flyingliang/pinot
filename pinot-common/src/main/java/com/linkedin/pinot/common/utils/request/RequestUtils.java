...
public class RequestUtils {
   ...
   *   <li>Query is aggregation/group-by with all aggregation functions in {@link #ALLOWED_AGGREGATION_FUNCTIONS}</li>
  ...
  public static boolean isFitForStarTreeIndex(SegmentMetadata segmentMetadata, BrokerRequest brokerRequest,
    ...
    for (AggregationInfo aggregationInfo : aggregationsInfo) {
      if (!ALLOWED_AGGREGATION_FUNCTIONS.contains(aggregationInfo.getAggregationType().toLowerCase())) {
        return false;
      }
